...
class AtividadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create atividade" do
    assert_difference("Atividade.count") do
      post atividades_url, params: { atividade: { data: @atividade.data, hora_final: @atividade.hora_final, hora_inicio: @atividade.hora_inicio, nome: @atividade.nome, status: @atividade.status } }
    end
  ...
  test "should update atividade" do
    patch atividade_url(@atividade), params: { atividade: { data: @atividade.data, hora_final: @atividade.hora_final, hora_inicio: @atividade.hora_inicio, nome: @atividade.nome, status: @atividade.status } }
